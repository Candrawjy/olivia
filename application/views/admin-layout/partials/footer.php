<footer class="sticky-footer">
    ...
    <?php if($this->uri->segment(1) == "kelola-umkm" && $this->uri->segment(2) == "add") { ?>
    ...
    <?php } else if($this->uri->segment(1) == "kelola-umkm" && $this->uri->segment(2) == "edit") { ?>
    <script type="text/javascript">
        var map = L.map('map').setView([-6.586674786040669, 106.80608902528489],13);
    ...
    <?php if($this->uri->segment(1) == "kelola-jasa" && $this->uri->segment(2) == "add") { ?>
    <script type="text/javascript">
        var map = L.map('map').setView([-6.586674786040669, 106.80608902528489],13);
    ...
    <?php } else if($this->uri->segment(1) == "kelola-jasa" && $this->uri->segment(2) == "edit") { ?>
    <script type="text/javascript">
        var map = L.map('map').setView([-6.586674786040669, 106.80608902528489],13);
